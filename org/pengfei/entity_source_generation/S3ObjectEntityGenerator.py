from org.pengfei.definition import TEMPLATE_FOLDER_PATH, CONFIG_PATH
...
class S3ObjectEntityGenerator:
    ...
    def generate_s3_object_entity_json_source(name, qualified_name, ps_dir_qualified_name, object_prefix, data_type,
                                              owner,
                                              description, **kwargs):
